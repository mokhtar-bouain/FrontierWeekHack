...
RESOURCE_GROUP="${RESOURCE_GROUP:-valueleak-rg-$SUFFIX}"
LOCATION="${LOCATION:-swedencentral}"

FOUNDRY_RESOURCE_NAME="${FOUNDRY_RESOURCE_NAME:-valueleak-foundry-$SUFFIX}"
PROJECT_NAME="${PROJECT_NAME:-valueleak-project}"

MODEL_DEPLOYMENT_NAME="${MODEL_DEPLOYMENT_NAME:-gpt-5.4}"
MODEL_NAME="${MODEL_NAME:-gpt-5.4}"
MODEL_VERSION="${MODEL_VERSION:-2026-03-05}"

LOG_ANALYTICS_NAME="${LOG_ANALYTICS_NAME:-valueleak-logs-$SUFFIX}"
APP_INSIGHTS_NAME="${APP_INSIGHTS_NAME:-valueleak-insights-$SUFFIX}"

SEARCH_SERVICE_NAME="${SEARCH_SERVICE_NAME:-valueleak-search-$SUFFIX}"
